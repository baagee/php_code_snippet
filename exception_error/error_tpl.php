...
<head>
    ...
    <style type="text/css">
        body{background-color:white;color:black;font:9pt/11pt verdana,arial,sans-serif}#container{margin:10px}.error_line{padding-left:.5em;color:red;font-weight:bold;background-color:white}a:link{font:9pt/11pt verdana,arial,sans-serif;color:red}a:visited{font:9pt/11pt verdana,arial,sans-serif;color:#4e4e4e}h1{color:#f00;font:18pt "Verdana";margin-bottom:.5em}.bg1{background-color:#fcf8e3;padding-left:5px}.bg2{background-color:#eee;font-weight:600}.table{font:11pt Menlo,Consolas,"Lucida Console"}.info{background:none repeat scroll 0 0 #f2dedf;border:0 solid #aaa;border-radius:10px 10px 10px 10px;color:#c04644;font-size:11pt;line-height:160%;margin-bottom:1em;padding:1em}.hljs{display:block;overflow-x:auto;padding:.5em;background:#fdf6e3;color:#657b83}.hljs-comment,.hljs-quote{color:#93a1a1}.hljs-keyword,.hljs-selector-tag,.hljs-addition{color:#859900}.hljs-number,.hljs-string,.hljs-meta .hljs-meta-string,.hljs-literal,.hljs-doctag,.hljs-regexp{color:#2aa198}.hljs-title,.hljs-section,.hljs-name,.hljs-selector-id,.hljs-selector-class{color:#268bd2}.hljs-attribute,.hljs-attr,.hljs-variable,.hljs-template-variable,.hljs-class .hljs-title,.hljs-type{color:#b58900}.hljs-symbol,.hljs-bullet,.hljs-subst,.hljs-meta,.hljs-meta .hljs-keyword,.hljs-selector-attr,.hljs-selector-pseudo,.hljs-link{color:#cb4b16}.hljs-built_in,.hljs-deletion{color:#dc322f}.hljs-formula{background:#eee8d5}.hljs-emphasis{font-style:italic}.hljs-strong{font-weight:bold}
    </style>
    <script>
...
if ($is_debug) {
    if (!empty($backtrace) && is_array($backtrace)) {
        ...
        if (!empty($err_php_code_arr)) {
            echo '<pre style="overflow: hidden;"><code class="php" style="padding-bottom: 0;overflow: hidden">';
            foreach ($err_php_code_arr as $line => $code) {
                if (!empty($code)) {
                    if ($err_line == $line) {
                        echo '</code>';
                        echo '<div class="error_line">' . $line . '. ' . $code . '</div>';
                        echo '<code class="php" style="padding-top: 0;overflow: hidden">';
                    } else {
                        echo $line . '. ' . $code;
                    }
                }
